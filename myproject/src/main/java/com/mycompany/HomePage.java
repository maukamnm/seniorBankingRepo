...
//	FeedbackPanel fp = new FeedbackPanel("fbPanel");
...
//	public void addFbPanel(){
//		fp = new FeedbackPanel("fbPanel");
	...
	public void addDepositComponents(){
		...
		depositAction.add(
				new AjaxEventBehavior("click") {
					...
					protected void onEvent(AjaxRequestTarget ajaxRequestTarget) {
						Service service = new Service();
						boolean showErrorMessage = service.deposit(Integer.valueOf(transactionAmount),userId);
